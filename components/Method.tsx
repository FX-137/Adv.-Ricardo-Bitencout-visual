    ...
    <section className="py-24 bg-[#0f172a] text-white">
      <div className="max-w-7xl mx-auto px-6 text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 relative max-w-6xl mx-auto">
          ...
          <div className="hidden md:block absolute top-12 left-[10%] w-[80%] h-[1px] bg-white/10 z-0"></div>
          
          {steps.map((step, i) => (
            <div key={i} className="relative z-10 group">
              <div className="w-24 h-24 bg-[#b49b67] text-[#0f172a] rounded-full flex items-center justify-center mx-auto mb-8 shadow-[0_0_30px_rgba(180,155,103,0.2)] group-hover:scale-110 group-hover:bg-white transition-all duration-500">
                <i className={`fas ${step.icon} text-2xl`}></i>
              </div>
              <h3 className="text-lg font-bold mb-3 font-serif">{step.title}</h3>
