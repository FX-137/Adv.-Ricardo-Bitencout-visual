      ...
      <div className="max-w-7xl mx-auto px-6 flex justify-between items-center relative z-[160]">
        ...
        <div className="flex items-center">
          <a 
            ...
            className="bg-[#25D366] hover:bg-white hover:text-[#0f172a] text-white px-5 sm:px-8 py-2 sm:py-3 rounded-full text-[10px] sm:text-[11px] font-bold uppercase tracking-widest flex items-center gap-2 shadow-lg transition-all transform hover:-translate-y-0.5 active:scale-95 pointer-events-auto block cursor-pointer relative z-[170]"
          >
